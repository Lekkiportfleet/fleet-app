      ...
      <div className="space-y-3">
        ...
        {requests?.map((r) => (
          ...
          >
            ...
            {r.status === "approved" && (
              <Link
                href={`/driver/requests/${r.id}/complete`}
                className="block text-center text-sm rounded-md bg-amber-500 hover:bg-amber-400 text-slate-950 font-medium py-2 transition-colors"
              >
                Complete purchase
              </Link>
            )}
